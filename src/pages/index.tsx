...
const content: Array<{
...
}> = [
  {
    ...
    text: "Ilmu teknik Mekatronika merupakan gabungan dari beberapa cabang ilmu teknik. Seperti Teknik Mesin/Mekanik dan Teknik Elektronika dengan menghubungkan teknologi informatika. Lulusan Teknik Mekatronika berkarir di industri Otomatisasi Industri, Instrumentasi dan kontrol, industri manufaktur dan bisa berkarier sebagai wirausaha.",
  },
  {
    id: 2,
    title: "Apa saja yang akan dipelajari ?",
    text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod iusto doloremque accusantium libero, vero commodi eligendi vitae accusamus quisquam quo veritatis, voluptatum deleniti velit, quam non. Eligendi, vitae asperiores. Ut.",
  },
  {
    id: 3,
    title: "Apa prospek kerja dari lulusan Mekatronika ?",
    text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod iusto doloremque accusantium libero, vero commodi eligendi vitae accusamus quisquam quo veritatis, voluptatum deleniti velit, quam non. Eligendi, vitae asperiores",
  },
  {
    id: 4,
    title: "Berapa tahun pembelajarannya ?",
    text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod iusto doloremque accusantium libero, vero commodi eligendi vitae accusamus quisquam quo veritatis.",
  },
];
...
const Home: NextPage = () => {
  ...
  return (
    <Layout title="Teknik Mekatronika - SMKN 69" navbarIsShow={true}>
        ...
        <Carousel slideInterval={5000}>
          <div className="flex h-full items-center justify-center text-white relative">
            <Image
              ...
              alt="Banner 1"
            />
            <div className="flex flex-col justify-center items-center h-full w-full backdrop-blur-[3px]">
      ...
      {/* Visi & Misi */}
      <section id="visi-misi" className="min-h-screen">
        <div className="container">
          <h1 className="text-3xl md:text-4xl lg:text-4xl font-bold text-center py-12 dark:text-white">
            Visi dan Misi
          </h1>

          <div className="flex flex-col md:flex-row lg:flex-row gap-6 w-full mx-auto">
            <div className="w-6/12">
              <Card>
                <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">
                  VISI
                </h5>
                <p className="font-normal text-secondary dark:text-secondary-dark">
                  Menjadi kompetensi keahlian yang inovatif, kompetitif, dan
                  produktif
                </p>
              </Card>
            </div>
            <div className="w-6/12">
              <Card>
                ...
                <ol type="1" className="leading-loose">
                  <li className="text-secondary dark:text-secondary-dark">
                    1. Memacu sikap terbuka peserta didik terhadap gagasan -
                    gagasan baru
                  </li>
                  <li className="text-secondary dark:text-secondary-dark">
                    2. Mengoptimalkan kompetensi peserta didik melalui pelatihan
                    mekatronika yang proposional dan terukur
                  </li>
                  <li className="text-secondary dark:text-secondary-dark">
                    3. Mengoptimalkan produktifitas peserta didik dengan
                    pembelajaran efektif
                  </li>
                  <li className="text-secondary dark:text-secondary-dark">
                    4. Penanaman nilai - nilai K3 dan kelestarian lingkungan
                    hidup dalam proses pembelajaran
                  </li>
                  <li className="text-secondary dark:text-secondary-dark">
                    5. Penanaman nilai - nilai budaya kerja 5S (Seiri, Seiton,
                    Seiso, Seiketsu, dan Shitsuke) dalam proses pembelajaran
                  </li>
                  <li className="text-secondary dark:text-secondary-dark">
                    6. Menjalin hubungan <i>link and match</i> dengan industri
                  </li>
                </ol>
              </Card>
            </div>
              ...
              <Tabs.Group aria-label="Tabs with icons" style="underline">
                {content.map((item, idx) => (
                  <Tabs.Item
                    ...
                    key={idx}
                  >
                    <div className="flex w-full flex-col md:flex-row lg:flex-row gap-4">
                      ...
                      <div className="w-full md:w-6/12 lg:w-6/12">
                        <h4 className="font-bold text-lg pb-2 dark:text-white">
                          {item.title}
                        </h4>
